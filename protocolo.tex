...
%TODO Porque se hace
%\section*{Propósito del proyecto} %Situación  actual
...
%Como encaja este estudio %TODO ver  versión anterior para ver como se
...
colaborativas comunitarias,  se han  realizado estudios acerca  de los
...
bugs\footnote{Crowston,  Kevin,  and   James  Howison.   ``The  social
  structure  of free  and open  source software  development.''  First
  Monday  10.2  (2005).}.   Es  importante  además  de  que  forma  se
...
personas \footnote{Ryan, Sharon, and  Rory V. O\'Connor. ``Development
  of  a  team measure  for  tacit  knowledge in  software  development
  teams.''  Journal  of Systems  and Software 82.2  (2009): 229-240.}.
Otros autores  han tocado el tema  de la forma en  que la comunicación
fluye entre  todo el equipo  de desarrollo,  además de mapearlo  a los
artefactos de  software que  estos programan  \footnote{Ehrlich, Kate,
  Giuseppe Valetto, and Mary  Helander.  ``Seeing inside: Using social
  network  analysis  to  understand   patterns  of  collaboration  and
  coordination   in   global   software  teams.''    Global   Software
  Engineering,   2007.   ICGSE   2007.    Second  IEEE   International
  Conference on.   IEEE, 2007.}.   Como se  puede observar  ya existen
...
%TODO Que se busca
\section{Objetivos}  %TODO  objetivos tangibles  y  en  linea con  el objetivo general de la %investigación
...
lanzamiento.
\item %Como saber quienes son los desarrolladores más importante %Cómo
afecta la buena o mala  relacion entre desarrolladores %Como afecta la
buena/mala relacion  entre los desarrolladores y  ustream %Como afecta
un bug RC en un paquete en especifico
\end{itemize}

%TODO Como se pretende determinar
\section{Metodología de investigación} %TODO Expandir esta sección Se
...
\section{Cronograma de trabajo} %TODO Gantt con entregables
%1 mes y medio marco teórico
%1 mes y medio obtención de datos
%1 mes y medio análisis de datos
%1 mes conclusiones

\begin{thebibliography}{9}
\bibitem[Crowston]{0} Crowston,  Kevin, and James  Howison \textit{The
    social  structure of  free and  open source  software development}
First Monday 10.2, 2005
\bibitem[Ryan]{1}    Ryan,    Sharon,    and   Rory    V.    O\'Connor
  \textit{Development  of  a  team  measure  for  tacit  knowledge  in
    software development teams}
 Journal  of Systems  and Software 82.2, 2009
\bibitem[Ehrlich]{2}Ehrlich, Kate, Giuseppe Valetto, and Mary  Helander
