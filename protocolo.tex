...
%Ejemplo  1.  Analizar  experimentalmente   un  proyecto  de  software
%especifico -i.e.  Debian GNU/Linux- para determinar  la existencia de
%factores humanos para la creación de lanzamientos predecibles




%TODO Como se pretende determinar
\chapter*{Metodología  de investigación}  %TODO Expandir  esta sección
...
``Seeing inside: Using social  network analysis to understand patterns
of collaboration and coordination  in global software teams.''  Global
Software Engineering,  2007.  ICGSE  2007.  Second  IEEE International
