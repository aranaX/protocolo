...
%TODO Este parrafo lo escribiria de forma diferente en la siguiente secuencia:
\begin{comment}
...
%TODO Hasta donde tengo entendido en el protocolo solo es necesario que pongas la estructura de tu trabajo, no asi el contenido, eso es más para la tesis.
...
% TODO Podes mencionar tambien recursos humanos (-e.g. Investigador, asesor, etc.)
\chapter{Recursos}
\begin{itemize}
...
%   2009
% \bibitem[Ehrlich]{2}Ehrlich, Kate, Giuseppe Valetto, and Mary
%   Helander \textit{Seeing inside: Using social network analysis to
%   understand patterns of collaboration and coordination in global
%   software teams} Global Software Engineering, 2007.  ICGSE 2007.
%   Second IEEE International Conference on.  IEEE, 2007
% \end{thebibliography}
